...
![Build](https://github.com/NHSDigital/immunization-history/workflows/Build/badge.svg?branch=master)

This is a RESTful HL7® FHIR® API specification for the *Immunization-History* API.
...
## Contributing
Contributions to this project are welcome from anyone, providing that they conform to the [guidelines for contribution](https://github.com/NHSDigital/immunization-history/blob/master/CONTRIBUTING.md) and the [community code of conduct](https://github.com/NHSDigital/immunization-history/blob/master/CODE_OF_CONDUCT.md).
...
Successful deployment of the API Proxy requires:
 ...
 1. A *Target Server* named `immunization-history-target`
 2. A *Key-Value Map* named `ih-variables`, containing any values you might need at proxy runtime
 2. A *Key-Value Map* named `ih-variables-encrypted`, containing any secrets you might need at proxy runtime
