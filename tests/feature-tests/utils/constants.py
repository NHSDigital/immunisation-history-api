...
APIM_EMAIL_ADDRESS = "apm-testing-internal-dev<<AT>>nhs.net"
...
DEFAULT_APP_ATTRIBUTES = {
    "jwks-resource-url": (
        "https://raw.githubusercontent.com/NHSDigital/identity-service-jwks/main/"
        "jwks/internal-dev/9baed6f4-1361-4a8e-8531-1f8426e3aba8.json"
    ),
...
class ApigeeUrl:
    ...
    CREATE_APP = f"{_BASE}/developers/{APIM_EMAIL_ADDRESS.replace('<<AT>>', '@')}/apps"
